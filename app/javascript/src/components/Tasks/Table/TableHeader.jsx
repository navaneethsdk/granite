  ...
  return (
    <thead>
      <tr>
        <th className="w-1" />
        <th
          className="text-bb-gray-600 bg-gray-50 px-6 py-3
        text-left text-xs font-bold uppercase
        leading-4 tracking-wider text-opacity-50"
        >
          {title}
        </th>
        {type === "pending" && (
          <th
            className="text-bb-gray-600 bg-gray-50 px-6 py-3 text-left
        ...
        {type === "completed" && (
          <>
            ...
            <th
              className="text-bb-gray-600 bg-gray-50 py-3 pl-6 text-center
            text-sm font-bold leading-4
            tracking-wider text-opacity-50"
            >
              Delete
